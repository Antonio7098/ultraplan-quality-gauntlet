...
Job: `review-opencode-agent-runtime-verification` (surface-review)
...
## Assignment: deep independent review of `opencode-agent-runtime` — OpenCode agent runtime adapter and session stores
...
Read the neutral context pack at `/home/antonioborgerees/coding/ultraplan/ultraplan-quality-gauntlet/review/jobs/context-opencode-agent-runtime/result.md`. Then inspect the actual source and tests yourself. Do not assume the context pack is complete.
