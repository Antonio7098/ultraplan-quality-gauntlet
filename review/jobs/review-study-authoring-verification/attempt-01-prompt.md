...
Job: `review-study-authoring-verification` (surface-review)
...
## Assignment: deep independent review of `study-authoring` — Study scaffolding, validation, summary
...
Read the neutral context pack at `/home/antonioborgerees/coding/ultraplan/ultraplan-quality-gauntlet/review/jobs/context-study-authoring/result.md`. Then inspect the actual source and tests yourself. Do not assume the context pack is complete.
