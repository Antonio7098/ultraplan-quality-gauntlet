...
Job: `review-web-security-boundary-verification` (surface-review)
...
## Assignment: deep independent review of `web-security-boundary` — Web security, session, and origin controls
...
Read the neutral context pack at `/home/antonioborgerees/coding/ultraplan/ultraplan-quality-gauntlet/review/jobs/context-web-security-boundary/result.md`. Then inspect the actual source and tests yourself. Do not assume the context pack is complete.
