...
Job: `review-repo-publication-verification` (surface-review)
...
## Assignment: deep independent review of `repo-publication` — Git stage publication
...
Read the neutral context pack at `/home/antonioborgerees/coding/ultraplan/ultraplan-quality-gauntlet/review/jobs/context-repo-publication/result.md`. Then inspect the actual source and tests yourself. Do not assume the context pack is complete.
