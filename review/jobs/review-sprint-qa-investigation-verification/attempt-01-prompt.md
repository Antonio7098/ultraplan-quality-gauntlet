...
Job: `review-sprint-qa-investigation-verification` (surface-review)
...
## Assignment: deep independent review of `sprint-qa-investigation` — QA adversarial investigation
...
Read the neutral context pack at `/home/antonioborgerees/coding/ultraplan/ultraplan-quality-gauntlet/review/jobs/context-sprint-qa-investigation/result.md`. Then inspect the actual source and tests yourself. Do not assume the context pack is complete.
