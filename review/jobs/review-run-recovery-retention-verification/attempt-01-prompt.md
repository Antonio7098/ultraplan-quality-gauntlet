...
Job: `review-run-recovery-retention-verification` (surface-review)
...
## Assignment: deep independent review of `run-recovery-retention` — Run-control recovery, migration, retention
...
Read the neutral context pack at `/home/antonioborgerees/coding/ultraplan/ultraplan-quality-gauntlet/review/jobs/context-run-recovery-retention/result.md`. Then inspect the actual source and tests yourself. Do not assume the context pack is complete.
